...
-- CreateIndex
CREATE UNIQUE INDEX "UserToProject_accountId_projectId_key" ON "UserToProject"("accountId", "projectId");

-- AddForeignKey
ALTER TABLE "UserToProject" ADD CONSTRAINT "UserToProject_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
